...
const RULES=['Shop Santé réapprovisionne chaque semaine les rayons de suppléments de quatre Metros (Innovation, St-Augustin, St-Nicolas, Ste-Foy). Les semaines vont du jeudi au mercredi, comme les rapports de ventes de Metro.',
 ...
 'La règle couvre la période de commande au rythme moyen des 4 dernières semaines et de toutes les semaines, arrondi à la caisse la plus proche (stock connu : délai de livraison et sécurité compris, moins le stock, arrondi à la caisse supérieure).',

...
export function jevRequest(lines,settings){
 ...
 lines.forEach((l,i)=>{
  const id='l'+i;
  state.lignes[id]={metro:l.metro,produit:l.product||l.sku,sku:l.sku,semaine_commandee:l.week,ventes_hebdo:l.history.map(h=>h.units),jours_de_vente:l.history.map(h=>h.days),rythme_4_sem:l.v4,rythme_toutes_sem:l.v12,tendance:l.trend,stock:l.stock,colis:l.pack,urgence:l.urgency,calcul:l.rule};

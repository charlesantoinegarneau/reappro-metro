...
export function planLines(rows,settings,today,catalog=null){
 ...
 for(const [key,{metro,sku,list,history,scaled}] of series){
  ...
  lines.push({key,metro,sku,product,brand,name,variant,cost,week,pack,stock,history,v4:round(v4),v12:round(v12),trend,urgency,base,rule,ruptures,boNow,candidates:candidates(base,v12>0)});
 }
